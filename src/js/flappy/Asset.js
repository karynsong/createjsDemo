...
var Asset = ns.Asset = Hilo.Class.create({
    ...
    load: function(){
        var resources = [
            {id:'bg', src:'//fe.benmu-health.com/createjsDemo/images/bg.png'},
            {id:'ground', src:'//fe.benmu-health.com/createjsDemo/images/ground.png'},
            {id:'ready', src:'//fe.benmu-health.com/createjsDemo/images/ready.png'},
            {id:'over', src:'//fe.benmu-health.com/createjsDemo/images/over.png'},
            {id:'number', src:'//fe.benmu-health.com/createjsDemo/images/number.png'},
            {id:'bird', src:'//fe.benmu-health.com/createjsDemo/images/bird.png'},
            {id:'holdback', src:'//fe.benmu-health.com/createjsDemo/images/holdback.png'}
        ];
